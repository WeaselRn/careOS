...
Resolution order for every key:
    settings.PLUGIN_CONFIGS["care_inventory"][key]  →  environment variable  →  DEFAULTS[key]
...
from care_inventory.apps import PLUGIN_NAME
...
class PluginSettings:  # pragma: no cover
    ...
    >>> from care_inventory.settings import plugin_settings
    >>> plugin_settings.INVENTORY_ENABLED
    """
